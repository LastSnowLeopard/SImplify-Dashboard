...
const Categories = ({setOpen,total,setInventoryData, data,category}) => {
    ...
    return (
        <div className="py-[27px] px-[22px] flex flex-col gap-[17px] lg:w-[330px] rounded-r-lg h-full" 
        style={{ background: 'linear-gradient(0deg, #222222, #222222),linear-gradient(0deg, #E0DCF9, #E0DCF9)' }}>
